...
internal class MenuPatch
{
	...
	private static string[] buttons = new string[]
	{
		...
		"Become Master",
		"Gamemode To Casual",
        "Gamemode To Infection",
        "Gamemode To Hunt",
        "Gamemode To Paintbrawl",
        "Invisible",
		"Ghost Monke",
		"Fly",
		"Speed Boost",
	...
	private static void Prefix()
	{
		try
		{
			...
			if (buttonsActive[16] == true)
			{
                ...
                list[0].TryGetFeatureValue(CommonUsages.triggerButton, out flag18);
		...
		{
			File.WriteAllText("Star+Spark_Menu_V1_error.log", ex.ToString());
		}
	...
	private static void ProcessPlatformMonke()
	{
		...
		colorKeysPlatformMonke[2].color = Color.red;
	...
	public static void Draw()
	{
		...
		text.text = "Stargazer+Sparks Menu V1";
		text.fontSize = 1;
